...
//--------------------------------------------------------------------------
#define MAX_MESSAGES 20						//tengo que bancar muchos mensajes porqu el acelerador de rotary me llena la cola sino...
...
//-----------------------------------------------------------------------------
void Add_Serial_Tx_Message(unsigned char* Start,unsigned int Size,unsigned char Type,State** Sm)	//escribe un nuevo dato a la cola...
{
...
void Atomic_Add_Serial_Tx_Message(unsigned char* Start,unsigned int Size,unsigned char Type,State** Sm)		{Atomic(Add_Serial_Tx_Message(Start,Size,Type,Sm));}
//-----------------------------------------------------------------------------
