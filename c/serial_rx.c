...
static char    Rx_Buffer[SERIAL_RX_BUFFER];
static unsigned int     Bytes2Read;
static char*            Point2Read;          //direccion de inicio en donde grabar los datos leidos
...
//----------------------------------------------------------------------------------------------
char              Serial_Rx_As_Char     ( unsigned int Pos ) { return Rx_Buffer[Pos];}
char*             Serial_Rx_As_PChar    ( unsigned int Pos ) { return Rx_Buffer+Pos;}
...
//--------------------------------------------------------------------------------
void Save4Serial(unsigned char Length,char *Data,unsigned char Time_Out,unsigned char Del)         //lee datos del puerto y los almacena en el lugar indicado
{
