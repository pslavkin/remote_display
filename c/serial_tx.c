...
void Send_NVData2Serial_Until_Delimiter ( unsigned int Length,char *Data,unsigned char Delimiter ) { Send_NV2Serial_Ans(Find_Char_On_String(Data,Delimiter,Length),Data,Transmit_Data_Message_Event,Empty_State_Machine);}
void Send_NVData2Serial_Until_Enter     ( unsigned int Length,char *Data                         ) { Send_NVData2Serial_Until_Delimiter(Length,Data,'\r')                                                               ;}
void Send_NLine_NVData2Serial           ( unsigned int Length,char *Data                         ) { Send_NLine2Serial()                                                                                                ;Send_NVData2Serial(Length,Data);}
void Send_VData2Serial                  ( unsigned int Length,char *Data                         ) { Send_V2Serial_Ans(Length,Data,Transmit_Data_Message_Event,Empty_State_Machine)                                     ;}
void Send_NLine_VData2Serial            ( unsigned int Length,char *Data                         ) { Send_NLine2Serial()                                                                                                ;Send_VData2Serial(Length,Data) ;}
void Send_Bool2Serial                   ( unsigned char Bool                                     ) { Send_NVData2Serial(5,Bool?"On \r\n":"Off\r\n")                                     ;}
