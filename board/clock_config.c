...
- {id: 'SCG::RCCR[DIVSLOW].bitField', value: Divide-by-5}
...
const scg_spll_config_t g_scgSysPllConfig_BOARD_BootClockRUN =
    {
        ...
        .div1 = kSCG_AsyncClkDivBy1,              /* System PLL Clock Divider 1: divided by 1 */
        .div2 = kSCG_AsyncClkDivBy2,              /* System PLL Clock Divider 2: divided by 2 */
        .src = kSCG_SysPllSrcFirc,                /* System PLL clock source is FIRC */
        .prediv = 3,                              /* Divided by 4 	(60Mhz / 4 = 15Mhz) */
        .mult = 0,                                /* Multiply Factor is 16  15Mhz*16/2=120Mhz que es lo que busco*/
    };
/*******************************************************************************
...
- {id: 'SCG::RCCR[DIVBUS].bitField', value: Divide-by-2}
- {id: 'SCG::RCCR[DIVSLOW].bitField', value: Divide-by-5}
- {id: 'SCG::VCCR[DIVBUS].bitField', value: Divide-by-2}
- {id: 'SCG::VCCR[DIVCORE].bitField', value: Divide-by-2}
- {id: 'SCG::VCCR[DIVSLOW].bitField', value: Divide-by-4}
- {id: 'SCG::VCCR[SCS].bitField', value: System OSC (SOSC_CLK)}
- {id: SCG_SIRCCSR_SIRCLPEN_CFG, value: Disabled}
- {id: SCG_SOSCCFG_OSC_MODE_CFG, value: ModeOscLowPower}
- {id: SCG_SOSCCFG_RANGE_CFG, value: Medium}
- {id: SCG_SOSCCSR_SOSCEN_CFG, value: Enabled}
