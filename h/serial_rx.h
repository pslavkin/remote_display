...
//--------------------------------------------------------------------
extern void 		Save4Serial 				(unsigned char Length,unsigned char *Data,unsigned char Time_Out,unsigned char Delimiter);
...
//--------------------------------------------------------------------
extern unsigned char  	Serial_Rx_As_Char		(unsigned int Pos);
extern unsigned char* 	Serial_Rx_As_PChar		(unsigned int Pos);
...
extern unsigned char* 	Serial_Rx_Loaded_Char		(void);
extern unsigned char* 	Serial_Rx_Loaded_Int		(void);
extern unsigned char* 	Serial_Rx_Loaded_Long		(void);
extern unsigned char 	Loaded_Binary_Char4Serial	(void);
//--------------------------------------------------------------------
