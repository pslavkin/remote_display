...
//--------------------------------------------------------------------
extern void 		Send_NVData2Serial_Ans	(unsigned int Length,unsigned char *Data);
extern void 		Send_VData2Serial_Ans	(unsigned int Length,unsigned char *Data);
//-------------------------------------------------------------------
extern void 		Send_NVData2Serial			(unsigned int Length,unsigned char *Data);
extern void 		Send_NVData2Serial_Until_Delimiter	(unsigned int Length,unsigned char *Data,unsigned char Delimiter);
extern void 		Send_NVData2Serial_Until_Enter		(unsigned int Length,unsigned char *Data);
extern void 		Send_NLine_NVData2Serial		(unsigned int Length,unsigned char *Data);
extern void 		Send_VData2Serial			(unsigned int Length,unsigned char *Data);
extern void 		Send_NLine_VData2Serial			(unsigned int Length,unsigned char *Data);
//--------------------------------------------------------------------
